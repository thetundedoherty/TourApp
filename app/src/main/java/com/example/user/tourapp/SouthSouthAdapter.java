...
public class SouthSouthAdapter extends ArrayAdapter {

    private static final String LOG_TAG = SouthSouthAdapter.class.getSimpleName();

    public SouthSouthAdapter(Activity context, ArrayList<TouristAttraction> touristAttractions) {
