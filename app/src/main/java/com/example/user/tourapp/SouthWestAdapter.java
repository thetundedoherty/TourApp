...
public class SouthWestAdapter extends ArrayAdapter {
    private static final String LOG_TAG = SouthWestAdapter.class.getSimpleName();

    public SouthWestAdapter(Activity context, ArrayList<TouristAttraction> touristAttractions) {
