...
public class SouthEastAdapter extends ArrayAdapter {
    private static final String LOG_TAG = SouthEastAdapter.class.getSimpleName();

    public SouthEastAdapter(Activity context, ArrayList<TouristAttraction> touristAttractions) {
