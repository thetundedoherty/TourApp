...
public class NorthCentralAdapter extends ArrayAdapter {

    private static final String LOG_TAG = NorthCentralAdapter.class.getSimpleName();

    public NorthCentralAdapter(Activity context, ArrayList<TouristAttraction> touristAttractions) {
