...
public class NorthWestAdapter extends ArrayAdapter {
    private static final String LOG_TAG = NorthWestAdapter.class.getSimpleName();

    public NorthWestAdapter(Activity context, ArrayList<TouristAttraction> touristAttractions) {
